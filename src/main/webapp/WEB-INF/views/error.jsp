...
<link href="${pageContext.request.contextPath}/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<link href="${pageContext.request.contextPath}/assets/admin/layout4/css/layout.css" rel="stylesheet" type="text/css"/>
<link href="${pageContext.request.contextPath}/assets/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css" id="style_color"/>
<link href="${pageContext.request.contextPath}/assets/admin/layout4/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<script src="${pageContext.request.contextPath}/assets/admin/layout4/scripts/layout.js" type="text/javascript"></script>
